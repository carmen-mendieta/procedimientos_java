package py.edu.ucsa.jdbc01.pool;
...
public class PoolConexiones implements Runnable {
	...
	public synchronized Connection getConnection()
		...
		if(!conexionesDisponibles.isEmpty()){ // si hay conexiones disponibles
			 ...
			 *  espera hasta que haya notificacion "notifyAll"y ahi intenta obtener devuelta una conexi�n.
			 */
	...
	public synchronized void libear(Connection connection) {
	...
	*/
	...
	public static void main(String[] args) throws SQLException {
		...
		PoolConexiones p = new PoolConexiones("org.postgresql.Driver",
							"jdbc:postgresql://localhost:5432/conta",
							"postgres",
							"12345",
							2,
							2,true);
